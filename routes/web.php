...
Route::middleware(['auth', 'not_banned', 'check.menu'])->group(function () {
    ...
    Route::post('/dashboard/funfact/auto-save', [UserDashboardController::class, 'saveAutoGeneratedFunfact'])->name('dashboard.funfact.auto-save');
    Route::post('/dashboard/funfact/report-error', [UserDashboardController::class, 'reportFunfactError'])->name('dashboard.funfact.report-error');
