...
<div class="max-w-2xl">
    <div class="rounded-sm border border-gray-200 bg-white p-6 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
        <h2 class="mb-5 text-base font-semibold text-slate-800 dark:text-zinc-50">Informasi Series</h2>
        ...
        <form method="POST" action="{{ route('admin.series.store') }}" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="title_romaji" value="{{ old('title_romaji') }}" required
                ...
                <div>
                    ...
                    <input type="text" name="title_japanese" value="{{ old('title_japanese') }}"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="total_volumes" value="{{ old('total_volumes') }}" min="1"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-zinc-200">Terbit Mulai</label>
                    <input type="date" name="published_from" value="{{ old('published_from') }}"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-zinc-200">Terbit Selesai</label>
                    <input type="date" name="published_to" value="{{ old('published_to') }}"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-zinc-200">Skor (0–10)</label>
                    <input type="number" name="score" value="{{ old('score') }}" min="0" max="10" step="0.01"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-zinc-200">Rank MAL</label>
                    <input type="number" name="rank" value="{{ old('rank') }}" min="1"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-zinc-200">MAL ID</label>
                    <input type="number" name="mal_id" value="{{ old('mal_id') }}" min="1"
                           class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">
                </div>
                <div class="sm:col-span-2">
                    ...
                    <textarea name="synopsis" rows="4"
                              class="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100">{{ old('synopsis') }}</textarea>
                </div>
                <div class="sm:col-span-2">
                    <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-zinc-200">Cover</label>
                    ...
                    <p class="mt-1 text-xs text-slate-400 dark:text-zinc-500">JPG / PNG / WebP — maks. 2 MB</p>
                </div>
            </div>

            <div class="flex gap-3 border-t border-gray-200 pt-4 dark:border-gray-800">
                <button type="submit"
