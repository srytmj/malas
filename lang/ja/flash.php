...
return [
    ...
    'collections' => [
        ...
        'imported' => ':count件のシリーズをコレクションにインポートしました（:skipped件はスキップ — 既に所有しているか、カタログにありません）。',
        'import_invalid' => 'ファイルが無効です。Malasのコレクションエクスポートファイルか確認してください。',
        'import_failed' => 'コレクションのインポートに失敗しました。後でもう一度お試しください。',
